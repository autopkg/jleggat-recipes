...
__all__ = ["LinkCheckerURLProvider"]

BASE_URL = 'http://wummel.github.io'
INDEX_PAGE = 'linkchecker'
re_dmg = '[^"]+\.dmg'

class LinkCheckerURLProvider(Processor):
        ...
        def get_url(self, base_url, download_page, re_url):
                ...
                return "/".join((base_url, download_page, m.group("url")))
...
if __name__ == '__main__':
        processor = LinkCheckerURLProvider()
